...
import type { NetballMatchState, IndoorFootballMatchState } from '@sportsync/shared';
import { api } from '@sportsync/api-client';
import { getNetballScoreboard, getFootballScoreboard } from '@sportsync/sport-rules';
