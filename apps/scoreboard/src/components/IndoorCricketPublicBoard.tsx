        ...
        >
          <div style={{ display: 'grid', gridTemplateRows: 'auto 1fr auto 1fr', gap: '0.5rem' }}>
            ...
            <div style={{ background: 'rgba(255,255,255,0.04)', borderRadius: 12, padding: '1rem' }}>
              ...
              {display.target != null && (
                <>
                  <div style={{ marginTop: '0.75rem', fontSize: '2rem', fontWeight: 800, color: primary }}>{display.target}</div>
              ...
              {display.skins.map((skin) => (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    background: skin.status === 'active' ? `${primary}22` : 'rgba(255,255,255,0.04)',
                ...
                >
                  ...
                  <div style={{ fontSize: '0.8rem', color: '#8b9cb3' }}>Skin {skin.skin}</div>
                  <div style={{ fontWeight: 700, fontSize: '1.1rem' }}>{skin.runs}/{skin.wickets}</div>
                </div>
              ))}
            </div>
          </div>
